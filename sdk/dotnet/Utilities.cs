...
namespace Pulumi.Lnvps
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Lnvps.version.txt");
    ...
    internal sealed class LnvpsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public LnvpsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
